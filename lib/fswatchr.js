      ...
      dirwalker.on('read', function(dirpath, dirstats) {
        ...
        _this.watchers[dirpath] = fs.watch(dirpath, function(event, filename) {
          ...
          return fs.lstat(p, function(err, stat) {
            var action, type, _ref, _ref1, _ref2;
            if (((stat != null) || (((_ref = _this.stats[dirpath]) != null ? _ref[p] : void 0) != null)) && !(typeof _this.filter === "function" ? _this.filter(p, stat) : void 0)) {
              action = _this._getAction(event, p, stat);
              type = dirwalker.getFileType(stat != null ? stat : (_ref1 = _this.stats[dirpath]) != null ? _ref1[p] : void 0);
              if (action === 'removed' && (((_ref2 = _this.stats[dirpath]) != null ? _ref2[p] : void 0) != null)) {
                delete _this.stats[dirpath][p];
              } else if (typeof stats !== "undefined" && stats !== null) {
                _this.stats[path.dirname(filename)][filename] = stat;
              }
              if (!(!type || action === 'unchanged')) {
